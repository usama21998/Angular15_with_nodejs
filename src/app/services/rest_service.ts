...
export class RestService {
    ...
    private authErrorCatch(e: { error: { message: any; }; }): Observable<never> {
         
        return throwError(e.error.message?e.error.message:e.error);
    }

    private _getHeader(headerType?: any | undefined): HttpHeaders {
    ...
    private _getHeaderDepo(headerType?: any): HttpHeaders {
